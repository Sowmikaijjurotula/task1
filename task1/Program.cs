...
namespace Task1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new student() { firstname = "Sowmika", lastname = "ijjurotula", smailid = "Sowmika@gmailcom", branch = "EE", percentage = 87,skills=new List<string>{"SQL","PHP" } },
                new student() { firstname = "Anjali", lastname = "k", smailid = "Anjali@gmailcom", branch = "CS", percentage = 89,skills = new List<string>{ "Python"} },
                new student() { firstname = "jabeen", lastname = "Syed", smailid = "jabeen@gmailcom", branch = "ME", percentage = 85,skills = new List<string>{"Java" }},
                new student() { firstname = "mmmm", lastname = "l", smailid = "mmmm@gmailcom", branch = "ME", percentage = 93,skills = new List<string>{"MySQL" } },
                new student() { firstname = "gowthami", lastname = "reddy", smailid = "gowthami@gmailcom", branch = "CS", percentage = 90,skills = new List<string>{".NET","SQL" } },
                new student() { firstname = "meghana", lastname = "kundela", smailid = "meghana@gmailcom", branch = "EE", percentage = 88,skills = new List<string>{ "ASP.NET"} }
            };
            ...
            var query10 = (from i in Slist where i.lastname.Contains('d') select i);
            ...
            var query17 = (from i in Slist where i.lastname == "ijjurotula" select i).FirstOrDefault();
            ...
            var query18 = (from i in Slist where i.lastname == "kundela" select i).Last();
            ...
            var query19 = (from i in Slist where i.lastname == "reddy" select i).LastOrDefault();
            ...
            var query20 = (from i in Slist where i.lastname == "syed" select i).Single();
            ...
            var query21 = (from i in Slist where i.lastname == "l" select i).SingleOrDefault();
            ...
            Slist.Add(new student() { firstname = "Vinit", lastname = "Wankkhede", smailid = "vinit@gmail.com", branch = "EE", percentage = 92 });
            Slist.Add(new student() { firstname = "Samir", lastname = "Telrandhe", smailid = "samir@gmail.com", branch = "ME", percentage = 91 });
            ...
            Slist.Add(new student() { firstname = "Shubhum", lastname = "Mude", smailid = "shubhum@gmail.com", branch = "EE", percentage = 86 });
